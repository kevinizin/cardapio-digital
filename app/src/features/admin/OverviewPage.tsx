...
import { getLiveTableStatus, type LiveTableState } from '../../domain/occupancy';
...
export function OverviewPage() {
  ...
  const counts = useMemo(() => {
    ...
    for (const table of data.tables) map[getLiveTableStatus(table, data, now).state] += 1;
    return map;
  }, [data, now]);
    ...
    <>
      ...
      <div className="kpi-grid">
        ...
        <div className="kpi">
          ...
          <p className="kpi__meta">{o.kpiPresentMeta(overview.presentReservations)}</p>
        </div>
        <div className="kpi">
          <p className="kpi__label">
            {o.kpiFree}
